...
from library.utilities.quart import abort, Blueprint, current_app, make_response, Quart, request, Response, websocket
    ...
    *,
    ...
    def decorator(func: Callable) -> Callable:
        if provide_automatic_options:
            func.required_methods = getattr(
                func, "required_methods", set())  # type: ignore
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            allow_headers = _sanitise_header_set(
                allow_headers, "QUART_CORS_ALLOW_HEADERS")
            allow_methods = _sanitise_header_set(
                allow_methods, "QUART_CORS_ALLOW_METHODS")
            allow_origin = _sanitise_origin_set(
                allow_origin, "QUART_CORS_ALLOW_ORIGIN")
            expose_headers = _sanitise_header_set(
                expose_headers, "QUART_CORS_EXPOSE_HEADERS")
...
def cors(
    ...
    *,
    ...
    app_or_blueprint.before_websocket(
        partial(_apply_websocket_cors, allow_origin=allow_origin))
